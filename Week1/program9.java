...
class Matrix
{
	...
	/////////////////////////////////////////////////////////
	//Function Name:    DiagonalAddition
	//Description:      addition of diagonal matrix elements
	//Input:            ---
	//Output:           int
	//Date:             03/11/2022
	//Author:           Manas Ohara
	////////////////////////////////////////////////////////
	protected int DiagonalAddition()
	{
		int iSum = 0;
		for(int iCnt = 0 ; iCnt < arr.length ; iCnt++ )
		{
...
class program9
{
	...
	{	
		...
		mobj.Accept();
		mobj.Display();
		int iSum = mobj.DiagonalAddition();
		System.out.println("Diagonal elements addition is : "+iSum);
	}
}
