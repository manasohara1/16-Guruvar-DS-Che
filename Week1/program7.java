...
class Matrix
{
	...
	//Description:      addition of even matrix elements
	//Input:            ---
	//Output:           int
	//Date:             03/11/2022
	//Author:           Manas Ohara
	////////////////////////////////////////////////////////
	protected int EvenAddition()
	{
		int iSum = 0;
		for(int iCnt = 0 ; iCnt < arr.length ; iCnt++ )
		{
...
class program7
{
	...
	{	
		...
		mobj.Accept();
		mobj.Display();
		int iSum = mobj.EvenAddition();
		System.out.println("Matrix even elements addition is : "+iSum);
	}
}
