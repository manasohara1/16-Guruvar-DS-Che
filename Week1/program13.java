...
class Matrix
{
	...
	/////////////////////////////////////////////////////////
	//Function Name:    SwapCol
	//Description:      swap cols of matrix
	//Input:            ---
	//Output:           ---
	//Date:             03/11/2022
	//Author:           Manas Ohara
	...
	{
		System.out.println("Matrix after col swap : ");
		for(int iCnt = 0 ; iCnt < arr.length ; iCnt = iCnt+1)
		{
			for(int jCnt = 0 ; jCnt < arr[iCnt].length -1; jCnt+=2)
			{
				int temp = arr[iCnt][jCnt];
				arr[iCnt][jCnt] = arr[iCnt][jCnt+1];
				arr[iCnt][jCnt+1] = temp;
			}
		}
		Display();
	}
